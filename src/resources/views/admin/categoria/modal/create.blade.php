                ...
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="descricao_categoria" rows="3" aria-describedby="alerta-descricao"  Required></textarea>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select" aria-label="Selecione uma opção" aria-describedby="alerta-ordem_categoria"  Required>
