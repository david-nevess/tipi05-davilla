                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    <div class="image-column col-md-6 col-sm-12">
                                        <figure class="image"><a href="{{ asset('davilla/images/'.$produto->foto_produto) }}" class="lightbox-image" title="{{ $produto->nome_produto }}"><img src="{{ asset('davilla/images/'.$produto->foto_produto) }}" alt="{{ $produto->nome_produto }}"><span class="icon fa fa-search"></span></a></figure>
                                    </div>
                                    <div class="info-column col-md-6 col-sm-12">
                                        ...
                                        <div class="other-options clearfix">
                                            ...
                                            <ul class="product-meta">
                                                <li class="posted_in">Categoria: <a href="#">{{ $produto->categoriaProduto->nome_categoria ?? 'Geral' }}</a></li>
                                                <li class="tagged_as">Tag: <a href="#">{{ $produto->categoriaProduto->nome_categoria ?? 'Geral' }}</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="shop-item col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <figure class="image"><a href="shop-single.html"><img src="{{ asset('davilla/images/'.$produto->foto_produto) }}" alt=""></a></figure>
